...
var $author$project$Squares$Main$GotViewport = function (a) {
...
var $author$project$Squares$Main$main = $elm$browser$Browser$element(
	{
		init: $author$project$Squares$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Squares$Main$update,
		view: $author$project$Squares$Main$view
	});
_Platform_export({'Squares':{'Main':{'init':$author$project$Squares$Main$main(
